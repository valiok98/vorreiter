...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $inputEmailUsername = $SAFE_POST["inputEmailUsername"];
    $adminData = [];
...
function send_email_to_admin($adminData)
{
    ...
    if ($adminData) {
        ...
        $url = URL . 'ajax/change_password/index.php?renew_pass_url=' . $renewPassURL;
        ...
        return json_encode(array("success" => true, "msg" => "Eine Email wurde an die eingegebene E-Mail Adresse(oder Benutzername) gesendet.\r\n Bitte checken Sie auch Ihre Spambox."));
    } else {
